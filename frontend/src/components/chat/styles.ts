...
export const styles = StyleSheet.create({
  ...
  tooltipPopover: {
    ...
    sourcesBottomSheetTitleRow: {
      flexDirection: 'row',
      alignItems: 'center',
      gap: 6,
    },
    sourcesBottomSheetTitle: {
      color: '#93c5fd',
      fontSize: 12,
      fontWeight: '800',
      letterSpacing: 1.2,
